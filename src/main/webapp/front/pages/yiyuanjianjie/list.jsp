  ...
  <div id="app">
    ...
    <fieldset class="search-container" style="text-align: center;margin: 50px 0;">
      <form class="layui-form" style="margin: 10px 0;">
        ...
        <div class="layui-inline" style="margin-left: 30px;">
          ...
          <button v-if="isAuth('yiyuanjianjie','新增')" @click="jump('../yiyuanjianjie/add.jsp')" type="button" class="layui-btn btn-theme">
    ...
    <div class="product">
      <div class="proBox" v-for="(item,index) in dataList" v-bind:key="index">
        ...
        <div class="proBoxtxt">
          <p>{{item.yiyuanmingcheng}}&nbsp;&nbsp;<span style="color: red;" v-if="item.price">{{item.price}} RMB</span></p>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        // 获取列表数据
        http.request('yiyuanjianjie/list', 'get', param, function(res) {
