				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>学校编号：</span>
							<span class="desc">
								{{detail.yiyuanbianhao}}
							</span>
						</div>
																																																												<div class="detail-item">
							<span>内容简介：</span>
							<span class="desc">
								{{detail.neirongjianjie}}
							</span>
						</div>
																								<div class="detail-item">
							<span>单位性质：</span>
							...
							<span>员工人数：</span>
							<span class="desc">
								{{detail.yuangongrenshu}}
							</span>
						</div>
																								<div class="detail-item">
							<span>学校院长：</span>
							<span class="desc">
								{{detail.yiyuanyuanzhang}}
							</span>
						</div>
																								<div class="detail-item">
							<span>成立日期：</span>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`yiyuanjianjie`);
