						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span class="desc">
								{{detail.analysis}}
																								...
																								<div class="detail-item">
							<span>试题类型，0：单选题 1：多选题 2：判断题 3：填空题（暂不考虑多项填空）：</span>
							<span class="desc">
								{{detail.type}}
							</span>
						</div>
																								<div class="detail-item">
							<span>试题排序，值越大排越前面：</span>
							<span class="desc">
								{{detail.sequence}}
							</span>
						</div>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`examquestion`);
