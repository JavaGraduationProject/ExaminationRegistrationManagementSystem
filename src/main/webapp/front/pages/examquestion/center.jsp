				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<label class="layui-form-label">所属试卷id（外键）</label>
							<div class="layui-input-block">
								<input type="text" name="paperid" id="paperid" placeholder="所属试卷id（外键）" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="analysis" id="analysis" placeholder="答案解析" autocomplete="off" class="layui-input">
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">试题类型，0：单选题 1：多选题 2：判断题 3：填空题（暂不考虑多项填空）</label>
							<div class="layui-input-block">
								<input type="text" name="type" id="type" placeholder="试题类型，0：单选题 1：多选题 2：判断题 3：填空题（暂不考虑多项填空）" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">试题排序，值越大排越前面</label>
							<div class="layui-input-block">
								<input type="text" name="sequence" id="sequence" placeholder="试题排序，值越大排越前面" autocomplete="off" class="layui-input">
							</div>
						</div>
