          ...
          <form class="layui-form">
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 0px;">
                <input type="text" id="adminid" name="adminid" placeholder="请输入管理员id" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 0px;">
                <input type="text" id="isreply" name="isreply" placeholder="请输入是否回复" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
