				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('zaixianbaoming','报名')" @click="onAcrossTap('baomingxinxi')" type="button" class="layui-btn">
								报名
							</button>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`zaixianbaoming`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
																									vue.title = vue.detail.baokaoxiangmu;
																														// 轮播图片
