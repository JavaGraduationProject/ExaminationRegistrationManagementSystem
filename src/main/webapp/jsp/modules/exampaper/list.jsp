...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>试卷表列表</span></li>
							</ol>
						</div>
					</div>
				</div>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('name')">试卷名称<i id="nameIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('time')">考试时长(分钟)<i id="timeIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('status')">试卷状态<i id="statusIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"exampaper");
