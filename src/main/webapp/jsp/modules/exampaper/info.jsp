						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="time" name="time" class="form-control" v-model="ruleForm.time" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>试卷状态</label>

									<input id="status" name="status" class="form-control" v-model="ruleForm.status==1?'启用':'禁用'" readonly>
									</div>
