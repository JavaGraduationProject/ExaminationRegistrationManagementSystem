				...
				<div class="row breadcrumb-bar">
					...
					<div class="col-md-6">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><span>试卷列表管理</span></li>
							<li class="breadcrumb-item active"><span>试卷列表</span></li>
						</ol>
					</div>
				</div>
			</div>
...
<input type="text" id="nameSearch"
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('time')">考试时间(分钟)<i
	...
	<%@ include file="../../static/crossBtnControl.js"%>
		...
		function exam(id){
			...
			window.open(baseUrl+'jsp/modules/exampaperlist/add-or-update.jsp');
		}
		$(document).ready(
				function() {
					//激活翻页按钮
